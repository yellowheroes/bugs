...
class Crud extends libs\CoreController
{
     ...
     * - className (Crud in this case) is automatically set as the 'views-directory' - lcfirst() - a views-directory can contain multiple page-views
    ...
    public function read($page='read', $id=null)
    {
        $this->index($page, $id);
    }

    public function update($page='update', $id=null)
    {
        $this->index($page, $id);
    }
     ...
     *                |     |   |    
     *                v     v   v
     * URL: src/app/crud/delete/3
     * thus invoke controller 'Crud.php',
     * run method 'delete()',
     * set argument $id=3 to be used by method delete()
     */
    public function delete($page='delete', $id=null)
    {
        $this->index($page, $id);
    }
}
